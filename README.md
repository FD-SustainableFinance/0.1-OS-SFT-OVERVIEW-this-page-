...
The funding from SF Skillnet allowed [First Derivative](https://www.linkedin.com/company/first-derivative/mycompany/) and its partner [Corlytics](https://www.linkedin.com/company/corlytics/) to embark on a series of research sprints to develop a plan along with initial research output to set a target for an open-source taxonomy project to benefit all.
