...
The first pool of contribution of taxonomies to OS-SFT comes from the combination of the initial funded research and the ongoing work of First Derivative Research Team. We are starting with circa 20 single taxonomies and circa 20 taxonomy mappings (see the [Taxonomy Libary](https://github.com/orgs/OS-SFT/projects/2/views/1)). These are supported by indivudal research repositories to help users better understanding the specific taxonomies.
